...
import 'forms/vehicle_info.dart';
import 'package:provider/provider.dart';
import '../../globals.dart';
import '../../theme/app_colors.dart';
import 'carlease.dart';

class ApplyCarLeaseScreen extends StatelessWidget {
  static const String id = 'ApplyCarLeaseScreen';

  ApplyCarLeaseScreen({Key? key}) : super(key: key);
  ...
  Widget line(width) => Container(
        width: (width / 3.65.w) - (width / 7.w),
        height: 3.h,
        decoration: BoxDecoration(color: AppColors.grey),
      );

  Widget spaceBetween(width) => SizedBox(width: (width / 40));

  SizedBox text(String text, double width, bool status) => SizedBox(
        width: (width / 3.5.w) - (width / 10.5.w) - 8.w,
        child: Text(text,
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        text(KeyLang.vehicleinfo.tr(), width, statuss >= 1),
                        spaceBetween(
                          width,
                        ),
                        ...
                        spaceBetween(width),
                        text(KeyLang.lenders.tr(), width, statuss == 4),
                        spaceBetween(width),
                        text(KeyLang.apply.tr(), width, statuss == 5),
                      ],
                    ),
                  ),
                ],
