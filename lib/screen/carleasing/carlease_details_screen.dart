...
import 'carlease_details_widget.dart';
...
import 'apply_carlease_loan.dart';

class CarLeaseDetailsScreen extends StatefulWidget {
  static const String id = 'LoanDetailsScreen';

  final String title;
  const CarLeaseDetailsScreen({Key? key, required this.title})
      : super(key: key);

  @override
  State<CarLeaseDetailsScreen> createState() => _CarLeaseDetailsScreen();
}

class _CarLeaseDetailsScreen extends State<CarLeaseDetailsScreen> {
          ...
          onTap: applyController.isLoading
              ...
              : () async {
                  ...
                  if (sentLoanDate?.isNotEmpty ?? false) {
                    ...
                    Navigator.pushNamed(context, ApplyCarLeaseScreen.id);
                  }
                },
          child: Container(
            width: double.infinity,
