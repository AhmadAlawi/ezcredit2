...
class InvestmentFundLoanWidget extends StatelessWidget {
  static const String id = 'GuestInvestmentFundLoanWidget';

  const InvestmentFundLoanWidget({
    Key? key,
  }) : super(key: key);
